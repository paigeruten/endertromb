...
public class GuiChat extends GuiScreen
{
    ...
    // Endertromb start
    public GuiChat(boolean ruby)
    {
        this.rubyMode = ruby;
    }

    public GuiChat(boolean ruby, String prompt)
    {
        this.rubyMode = ruby;
        this.prompt = prompt;
    }
    ...
    public void initGui()
    {
        ...
        int promptWidth = 0;
        if (this.rubyMode) {
            promptWidth = this.fontRenderer.getStringWidth(this.prompt);
        }
        // Endertromb end

        Keyboard.enableRepeatEvents(true);
        this.sentHistoryCursor = this.mc.ingameGUI.getChatGUI().getSentMessages().size();
        this.inputField = new GuiTextField(this.fontRenderer, 4 + promptWidth, this.height - 12, this.width - 4 - promptWidth, 12); // Endertromb
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        // Endertromb start
        if (this.rubyMode) {
            this.fontRenderer.drawStringWithShadow(this.prompt, 4, this.height - 12, this.promptColor);
        }
        // Endertromb end
